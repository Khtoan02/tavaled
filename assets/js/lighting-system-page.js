...
(function ($) {
  ...
  var lightingSystemPage = {
    ...
    initSliders: function () {
      var sliders = $(".lighting-system-page .lighting-system-category-slider");
      if (!sliders.length) {
        return;
      }
      ...
      sliders.each(function () {
        var slider = $(this);
        var track = slider.find(".lighting-system-category-slider-track");
        var cards = track.find(".category-product-card");
        var prevBtn = slider.find(".lighting-system-slider-nav.lighting-system-slider-prev");
        var nextBtn = slider.find(".lighting-system-slider-nav.lighting-system-slider-next");
    ...
    initResponsive: function () {
      ...
      function checkMobileNav() {
        ...
        sliders.each(function () {
          ...
          var navButtons = slider.find(".lighting-system-slider-nav");
