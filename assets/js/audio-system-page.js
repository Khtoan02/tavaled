...
(function ($) {
  ...
  var audioSystemPage = {
    ...
    initSliders: function () {
      var sliders = $(".audio-system-page .audio-system-category-slider");
      if (!sliders.length) {
        return;
      }
      ...
      sliders.each(function () {
        var slider = $(this);
        var track = slider.find(".audio-system-category-slider-track");
        var cards = track.find(".category-product-card");
        var prevBtn = slider.find(".audio-system-slider-nav.audio-system-slider-prev");
        var nextBtn = slider.find(".audio-system-slider-nav.audio-system-slider-next");
    ...
    initResponsive: function () {
      ...
      function checkMobileNav() {
        ...
        sliders.each(function () {
          ...
          var navButtons = slider.find(".audio-system-slider-nav");
